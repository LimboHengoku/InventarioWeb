...
import pe.com.inventario.web.service.UserDetailsServiceImpl;
import pe.com.inventario.web.util.Encriptador;
...
extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/equipos/antivirusYSo").hasAnyAuthority(roles)
